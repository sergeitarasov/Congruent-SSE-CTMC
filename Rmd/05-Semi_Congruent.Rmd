...
#   )
ecdf_del <- list(
  t100  = ecdf(del.aic$t100),
  t500  = ecdf(del.aic$t500),
  t1000 = ecdf(del.aic$t1000)
)
...
ecdf_del_bic <- list(
  t100_ecdf  = ecdf(del.bic$t100),
  t500_ecdf  = ecdf(del.bic$t500),
  t1000_ecdf = ecdf(del.bic$t1000)
)
...
# Plot the ECDFs for each group with varying linetypes
cdf_plot <- ggplot() +
  stat_ecdf(data = ecdf_data_combined, aes(x = Value, linetype = Group, color=IC), geom = "step", pad = F, size = .4) +
  #stat_ecdf(data = ecdf_data_combined, aes(x = Value, linetype = Group, color = IC), geom = "line", pad = F, size = 0.5)
...
ggsave("Figs/cdf.pdf", plot = cdf_plot , width = 8.7, height = 5, units = "cm",  useDingbats = FALSE)
```
...
# Define linetypes for each group
#linetypes <- c("100 tips" = "longdash", "500 tips" = "twodash", "1000 tips" = "solid")
linetypes <- c("100 tips" = "dotted", "500 tips" = "dashed", "1000 tips" = "solid")
colortypes <- c("100 tips" = "#619CFF", "500 tips" = "#00BA38", "1000 tips" = "#F8766D")
#linetypes <- c("100 tips" = "dotted", "500 tips" = "dashed")
...
cdf_plot <- ggplot() +
  ...
  theme(
    ...
    legend.position = c(0.85, 0.35),
    legend.margin = margin(0, 0, 0, 0),    
    legend.box.margin = margin(0, 4, 0, 2) 
    #legend.spacing = unit(0.01, "cm") 
)
