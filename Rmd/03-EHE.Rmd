...
Now we create EHE8-C using by decomposing our known parameter estimates into just two parameters: (1.) speciation and transitions rates equal to 0.1; and extinction equal to 0.01.
...
Compare Ln estimates, they are the same
