...
```{r}
args <- argnames_HiClaSSE(16)
#args$arrays
#args$pars
#length(args$pars)
reoder_lambdas(args$arrays, c(1,3,5,7,9,11,13,15,  2,4,6,8,10,12,14,16))
```
...
#phy <- readRDS(file='R/data/phy_CID4-100tips-100tr.RDS')
#phy[[1]]
...
# for (base in files_base){
#   file_in=paste0('R/data/lik-CID4-', base, '.RDS')
#   print(paste0('Reading file: ',file_in))
#   rds <- readRDS(file=file_in)
#   #aic = get_item(rds, 'lnLik') %>% get_aic(., 4)
# }
...
ecdf_del$t100_ecdf(2)
ecdf_del$t500_ecdf(2)
ecdf_del$t1000_ecdf(2)
...
ggsave("Figs/cdf.png", plot = cdf_plot , width = 8.7, height = 5, units = "cm")
  ...
  # scale_y_continuous(
  #   breaks = seq(0, 1, by = 0.1)  # Adjust the sequence for your specific data
  # # ) +
  # theme(
  #   panel.grid.minor.x = element_blank()  # Remove minor grid lines on the x-axis
  # )
