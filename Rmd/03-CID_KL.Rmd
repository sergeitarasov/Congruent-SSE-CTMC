...
get_item(CID4, 'lnLik') %>% mean()
get_item(CID8, 'lnLik') %>% mean()
get_item(COR8_C, 'lnLik') %>% mean()
get_item(CID8_NC, 'lnLik') %>% mean()
get_item(CID8cl_NC , 'lnLik') %>% mean()
get_item(COR8_NC, 'lnLik') %>% mean()
# [1] -304.7515
# [1] -304.7515
# [1] -304.7515
# [1] -304.7844
...
```
```{r}
get_item(CID4, 'lnLik') %>% get_aic(., 4) %>% mean()
get_item(CID8, 'lnLik') %>% get_aic(., 4) %>% mean()
get_item(COR8_C, 'lnLik') %>% get_aic(., 4) %>% mean()
get_item(CID8_NC, 'lnLik') %>% get_aic(., 4) %>% mean()
get_item(CID8cl_NC , 'lnLik') %>% get_aic(., 4) %>% mean()
get_item(COR8_NC, 'lnLik') %>% get_aic(., 4) %>% mean()
...
hist(get_item(COR8_NC, 'lnLik'), col='red', breaks=30)
hist(get_item(CID8_NC, 'lnLik'), col = rgb(0, 0, 1, 0.5), add = TRUE, breaks=30)
```
```{r}
hist(get_item(COR8_NC, 'lnLik') - get_item(CID8_NC, 'lnLik'), breaks=30)
