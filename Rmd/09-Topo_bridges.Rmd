...
Note the slight differences in model names between here and the main text. What is referred to as CID8-A and CID8-B in the main text corresponds to CID8a-NC and CID8-NC here, respectively.
...
colnames(daic) <- c("CID4",     "COR8_C",   "COR8_NC",  "CID8-B:(CID8_NC)",  "CID8-A:(CID8a_NC)")
```
